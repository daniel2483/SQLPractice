...
DECLARE cur_ CURSOR FOR select idTemp_preventivos_revenue_share, nemonico,fecha,fecha_completado from Temp_preventivos_revenue_share where cargado = 1 AND completado = 1;
